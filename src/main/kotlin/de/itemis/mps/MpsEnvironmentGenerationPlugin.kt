...
class MpsEnvironmentGenerationPlugin : Plugin<Project> {
    ...
    override fun apply(project: Project) {
        ...
        project.extensions.add(typeOf<NamedDomainObjectContainer<MpsConfigurationGenerationSettings>>(), "mpsEnvironments", serverEnvironmentContainer)

        serverEnvironmentContainer.forEach({ settingsExtension ->

                println("aaaaaa $settingsExtension")
